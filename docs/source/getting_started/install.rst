...
Now you can add apaxTools to your project by running

.. highlight:: bash
.. code-block:: bash

    poetry add git+https://github.com/apaxTools/apax.git
...
.. code-block:: bash
    ...
    git clone https://github.com/apaxTools/apax.git <dest_dir>
    cd <dest_dir>
    poetry install
